...
def hide_word
@secret_word = guessing_word.triguessing_word. "-")
secret_word
end
...
puts "Now Guess The World, Stupid."
...
puts "\n"
puts "-------------------------------"
puts "Play #2, you have #{wordguess.guesses} guesses and your word #{wordguess.hide_word}."
...
puts "You have #{wordguess.guesses} guesses left, and your word is #{wordguess.secret.word}."
...
puts "WE HAVE A WINNER. SUPRISINGLY."
else
put wordguess.guessing_word
